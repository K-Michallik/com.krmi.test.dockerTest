...
public class DockerDaemonProgramNodeView implements SwingProgramNodeView<DockerDaemonProgramNodeContribution> {
	...
	public DockerDaemonProgramNodeView(Style style) {
		this.style = style;
	}

	@Override
	public void buildUI(JPanel panel, ContributionProvider<DockerDaemonProgramNodeContribution> provider) {
	...
	private Box createInput(final ContributionProvider<DockerDaemonProgramNodeContribution> provider) {
