...
public class DockerDaemonProgramNodeContribution implements ProgramNodeContribution {
	private static final String NAME = "name";

	private final ProgramAPIProvider apiProvider;
	private final DockerDaemonProgramNodeView view;
	private final DataModel model;

	private Timer uiTimer;
	private KeyboardInputFactory keyboardInputFactory;

	public DockerDaemonProgramNodeContribution(ProgramAPIProvider apiProvider, DockerDaemonProgramNodeView view, DataModel model) {
	...
	private DockerDaemonInstallationNodeContribution getInstallation(){
		return apiProvider.getProgramAPI().getInstallationNode(DockerDaemonInstallationNodeContribution.class);
	}
}
